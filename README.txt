...
a persistence unit "prueba63panoraPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba63panora/pom.xml":
...
artifact ("prueba63panora.war") is already built. You can build
